...
class HyperoptSinkNodeParameterSpace(HyperoptNodeParameterSpace, SinkNodeParameterSpace):
    pass


class HyperoptSourceNodeParameterSpace(HyperoptNodeParameterSpace, SourceNodeParameterSpace):
    pass
